        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".icon-menu")) {
                    ...
                    if (isMenuOpen) functions_menuClose(); else {
 ...
 */        var MEDIA_PREFERS_REDUCED_MOTION = "(prefers-reduced-motion: reduce)";
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            arrowsSlider.forEach(((slider, index) => {
                ...
                let nextArrow = null;
                if (parent) {
                    prevArrow = parent.querySelector(".slider-arrows__arrow--prev");
                    nextArrow = parent.querySelector(".slider-arrows__arrow--next");
                }
                let options = {
                    perMove: 1,
                    arrows: false,
